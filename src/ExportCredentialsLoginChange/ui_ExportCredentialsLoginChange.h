/********************************************************************************
** Form generated from reading UI file 'ExportCredentialsLoginChangeFmrVgB.ui'
**
...
#ifndef EXPORTCREDENTIALSLOGINCHANGEFMRVGB_H
#define EXPORTCREDENTIALSLOGINCHANGEFMRVGB_H
...
""));
        ...
        LoginLabel->setGeometry(QRect(10, 65, 311, 81));
        QFont font;
...
"border: none;"));
    ...
    void retranslateUi(QWidget *Form)
    {
        ...
        LoginLabel->setText(QCoreApplication::translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; color:#efefef;\">Create Different Login Credentials</span></p><p align=\"center\"><span style=\" font-size:10pt; color:#efefef;\"> For Exported Credential File</span></p></body></html>", nullptr));
    } // retranslateUi

};

namespace Ui {
    class LoginChangeForm: public Ui_LoginChangeForm {};
} // namespace Ui

QT_END_NAMESPACE

#endif // EXPORTCREDENTIALSLOGINCHANGEFMRVGB_H
